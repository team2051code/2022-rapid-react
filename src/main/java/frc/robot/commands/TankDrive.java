...
public class TankDrive extends CommandBase {
    ...
    public TankDrive(DriveTrain drivetrain, Pneumatics pneumatics, ShootParamaters Shootparameters,
            SingulatorInformation singulatorInformation, ClimbControls climbControls) {
    ...
    public void execute() {
        ...
        //Control mode For Slower movement for greater precision
        m_driveTrain.SlowerControls();
